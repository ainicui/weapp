  ...
  methods: {
    ...
    onTap: function onTap(event) {
      ...
      if (this.data.tabs[index].disabled) {
        ...
        // this.trigger('click', index); 与wepy click事件重名
        this.trigger('onClick', index);
    ...
    observerContentScroll: function observerContentScroll() {
      ...
      var windowHeight = wx.getSystemInfoSync().windowHeight; // @ts-ignore
